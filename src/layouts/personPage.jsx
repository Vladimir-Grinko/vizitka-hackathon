      ...
      {person && (
        <>
          <div className="d-flex justify-content-between">
            ...
            <Button
              color={person.bookmark ? 'secondary' : 'primary'}
              nameButt={'Избранное'}
          ...
          <img
            className="image float-sm-none float-md-start me-3"
            src={person.image}
          ...
          <p>
            <b>Социальные сети:</b>{' '}
            {Object.entries(person.social).map((social) => (
              <a target="_blank" className="me-2" key={social[0]} href={social[1]} rel="noreferrer">
                {social[0]}
              </a>
            ))}
          </p>
